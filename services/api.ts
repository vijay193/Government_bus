...
export const api = {
    ...
    getSchedulesByDistrict: (district: string): Promise<Schedule[]> =>
        apiFetch(`${API_BASE_URL}/schedules/district/${encodeURIComponent(district)}`),
    ...
    bookFreeSeats: (
        ...
        apiFetch(`${API_BASE_URL}/bookings/free`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    getUserBookings: (userId: string): Promise<UserBooking[]> =>
        apiFetch(`${API_BASE_URL}/bookings/user/${encodeURIComponent(userId)}`),
    ...
    getSetting: (key: string): Promise<{ key: string; value: string }> =>
        apiFetch(`${API_BASE_URL}/settings/${key}`),
    ...
    getDiscountedDistricts: (): Promise<string[]> =>
        apiFetch(`${API_BASE_URL}/discounts/districts`),
    ...
    bulkCreateBeneficiaries: (beneficiaries: ParsedBeneficiary[]): Promise<{ message: string; created: number; updated: number; skipped: number }> =>
        apiFetch(`${API_BASE_URL}/users/bulk-beneficiaries`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    createSubAdmin: (data: Partial<User>): Promise<User> =>
        apiFetch(`${API_BASE_URL}/users/subadmin`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(data),
        }),
    ...
    adminUpdateUser: (userId: string, data: Partial<User>): Promise<User> =>
        apiFetch(`${API_BASE_URL}/users/admin/${encodeURIComponent(userId)}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(data),
        }),
    ...
    updateSubAdmin: (userId: string, data: Partial<User>): Promise<User> =>
        apiFetch(`${API_BASE_URL}/users/subadmin/${encodeURIComponent(userId)}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(data),
        }),
    ...
    deleteUser: (userId: string): Promise<void> =>
        apiFetch(`${API_BASE_URL}/users/${encodeURIComponent(userId)}`, {
            method: 'DELETE',
        }),

    updateUserProfile: (userId: string, data: Partial<User>): Promise<User> =>
        apiFetch(`${API_BASE_URL}/users/profile/${encodeURIComponent(userId)}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(data),
        }),
    ...
    getAllSchedules: (): Promise<Schedule[]> =>
        apiFetch(`${API_BASE_URL}/schedules`),
    ...
    updateSchedule: (scheduleId: string, data: { busName: string; seatLayout: SeatLayout; bookingEnabled: boolean; stops: ParsedStop[] }): Promise<Schedule> =>
        apiFetch(`${API_BASE_URL}/schedules/${encodeURIComponent(scheduleId)}`, {
            method: 'PUT',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(data),
        }),
    ...
    batchUploadSchedules: (schedules: ParsedSchedule[]): Promise<{ message: string }> =>
        apiFetch(`${API_BASE_URL}/schedules/batch-upload`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
    ...
    getRevenueAnalytics: (): Promise<RevenueAnalyticsData> =>
        apiFetch(`${API_BASE_URL}/analytics/revenue`),
};